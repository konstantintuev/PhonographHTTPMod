...
package com.kabouzeid.http.wifihotspotutils;
...
public class WifiApManager {
	...
	public boolean setWifiApEnabled(WifiConfiguration wifiConfig, boolean enabled) {
		try {
			...
			boolean res = (Boolean) method.invoke(mWifiManager, wifiConfig, enabled);
			if (!enabled) { // disable WiFi in any case
    ...
    public boolean isWifiConnected() {
	    return mWifiManager.getConnectionInfo() != null && mWifiManager.getConnectionInfo().getIpAddress() != 0;
    }
    ...
    public InetAddress wifiIpAddress() {
        ...
        try {
            ipAddress1 = InetAddress.getByAddress(ipByteArray);
	...
	public boolean setWifiApConfiguration(WifiConfiguration wifiConfig) {
		try {
			...
			boolean result =  (Boolean) method.invoke(mWifiManager, wifiConfig);
			Thread.sleep(500);
    ...
    public void justWifi(boolean enabled) {
