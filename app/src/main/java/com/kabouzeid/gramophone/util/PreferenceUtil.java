package com.kabouzeid.http.util;
...
import com.kabouzeid.http.helper.SortOrder;
...
public final class PreferenceUtil {
    ...
    public void setOnline(boolean online) {
        mPreferences.edit().putBoolean("online", online).apply();
    }

    public boolean getOnline() {
        return mPreferences.getBoolean("online", true);
    }
}
